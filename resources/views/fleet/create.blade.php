...
@section('content')
  <div id="event-create-container" class="col-md-8 offset-md-2 border">
    <form action="{{ route('fleet.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="form-group col-md-4">
          <label for="cnhRegisterNumber" class="form-label" id="cnh"maxlength="11">CNH</label>
        ...
        <div class="form-group col-md-4">
          <label for="cnhSecurityNumber" class="form-label" id="codigo-seguranca-cnh" maxlength="9">Código de
            segurança</label>
